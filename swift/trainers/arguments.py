...
class TrainArgumentsMixin:
    ...
    # Multiview graph training parameters
    image_text_lr_scale: float = 0.1  # Learning rate scale for image/text encoders to preserve alignment
    graph_lr: Optional[float] = None  # Learning rate for graph encoder (default: same as learning_rate)
