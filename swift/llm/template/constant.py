...
class MLLMTemplateType:
    ...
    qwen2_vl = 'qwen2_vl'
    qwen2_vl_graph = 'qwen2_vl_graph'
    qwen2_5_vl = 'qwen2_5_vl'
    qwen2_5_vl_graph = 'qwen2_5_vl_graph'  # Graph-enabled Qwen2.5-VL template
    ...
    llava1_6_mistral_graph_hf = 'llava1_6_mistral_graph_hf'  # Graph-enabled LLaVA-1.6-Mistral
    ...
    internvl2 = 'internvl2'
    internvl2_graph = 'internvl2_graph'  # Graph-enabled InternVL2 template
    ...
    glm4v = 'glm4v'
    glm4_1v = 'glm4_1v'
    glm4_1v_graph = 'glm4_1v_graph'  # Graph-enabled GLM4.1V template (non-MoE, good for embedding learning)
    ...
    phi3_vision_graph = 'phi3_vision_graph'  # Graph-enabled template for Phi-3.5-vision
    phi4_multimodal = 'phi4_multimodal'
    phi4_multimodal_graph = 'phi4_multimodal_graph'  # Graph-enabled template for Phi-4-multimodal
    florence = 'florence'
    molmo = 'molmo'
